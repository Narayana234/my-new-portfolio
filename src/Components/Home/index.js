      ...
      <section id="home" className="home fade-in">
        <div className="home-content">
          ...
          <p className="description">
            ...
            I'm constantly learning, building, and sharing with the world through my <a href="#about"><strong>projects</strong></a>and my <a href="https://www.youtube.com/@LNSkillSquad" target="_blank" rel="noopener noreferrer"><strong>YouTube channel</strong></a>.
          </p>
